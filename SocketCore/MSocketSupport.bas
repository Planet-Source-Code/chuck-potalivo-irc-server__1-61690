...
Private Function WindowProc(ByVal hwnd As Long, ByVal uMsg As Long, ByVal wParam As Long, ByVal lParam As Long) As Long
    ...
    If uMsg = p_lngWinsockMessage Then  'Modified: 04-MAR-2002
        ...
        '
        'If objSocket.DebugMode Then dbgHelper.PrintConsole " WinsockMessage (Socket: " & wParam & "): " & lngEventID
        '
...
Public Function InitWinsockService() As Long
    ...
    If Not m_blnWinsockInit Then
        ...
        If lngRetVal <> 0 Then
            ...
            '
        Else
            'dbgHelper.PrintConsole "InitWinsockServer - Complete."
            '
    ...
    End If
    '
    'dbgHelper.PrintConsole "    InitWinsockServer - New Instance Loaded."
    '
End Function
